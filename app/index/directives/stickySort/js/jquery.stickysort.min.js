(function(factory) {
   ...
   a.throttle = function(delay, fn, immediate, debounce) {
        var curr = +new Date(),
        //当前事件
            last_call = 0,
            last_exec = 0,
   ...
   a.debounce = function (delay,fn,  immediate) {
        return a.throttle( delay,fn, immediate, true);
    };
    ...
    a.fn.stickySort = function(c) {
        ...
        this.each(function() {
            if (a(this).is("table") && a(this).find("thead").length > 0 && a(this).find("th").length > 0) {
                ...
                f.load(e).resize(a.debounce(b.resizeThrottle,
                    function() {
                        e();
                        d()
                ...
                if (b.sortable || (i.data("sortable") != undefined || i.hasClass("sortable"))) {
                    ...
                    k.on("click", ".sticky-enabled thead th, .sticky-thead thead th, .sticky-col thead th, .sticky-intersect thead th",
                        function() {
                            var q = a(this),
                                p = q.index(),
